...
public class ConfigScreenHUDQuiver extends Screen {
    ...
    protected void init() {
        ...
        this.optionsRowList.addBig(new BooleanOption("hud_quiver.config.animate", u -> ConfigHUDQuiver.CLIENT.ANIMATE.get(), (u, newValue) -> ConfigHUDQuiver.CLIENT.ANIMATE.set(newValue)));
        this.optionsRowList.addBig(new BooleanOption("hud_quiver.config.hide", u -> ConfigHUDQuiver.CLIENT.HIDE.get(), (u, newValue) -> ConfigHUDQuiver.CLIENT.HIDE.set(newValue)));
        this.optionsRowList.addBig(new SliderPercentageOption("hud_quiver.config.horizontal_offset", 0, 512, 8,u -> (double) ConfigHUDQuiver.CLIENT.HORIZONTAL_OFFSET.get(),(u, newValue) -> ConfigHUDQuiver.CLIENT.HORIZONTAL_OFFSET.set(newValue.intValue()),(gs, option) -> new StringTextComponent(I18n.get("hud_quiver.config.horizontal_offset") + ": " + (int) option.get(gs))));
        this.optionsRowList.addBig(new SliderPercentageOption("hud_quiver.config.vertical_offset", 0, 512, 8, u -> (double) ConfigHUDQuiver.CLIENT.VERTICAL_OFFSET.get(), (u, newValue) -> ConfigHUDQuiver.CLIENT.VERTICAL_OFFSET.set(newValue.intValue()), (gs, option) -> new StringTextComponent(I18n.get("hud_quiver.config.vertical_offset") + ": " + (int) option.get(gs))));
